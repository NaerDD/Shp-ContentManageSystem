<template>
  <div>
    ...
    <!-- 抽屉效果 -->
    <el-drawer :visible.sync="show" :show-close="false" size="35%" > 
      <el-row>
      ...
      <el-col :span="16">
        <template>
          <el-tag type="success" :key="attr.id" v-for="(attr,index) in skuInfo.skuAttrValueList" style="margin-right:10px"
          >{{attr.attrId0}}-{{attr.valueId}}</el-tag>
        </template>
      </el-col>
    </el-row>
      <el-row>
